...
public interface IApoliceService
{
  ...
  Task<PagedResult<ApoliceDto>> ListarAsync(int pagina, int tamanhoPagina, string? status, Guid? clienteId, string? ordenarPor, CancellationToken cancellationToken = default);
